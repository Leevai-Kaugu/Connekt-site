...
import { CreditCard, ArrowRightLeft, ShieldCheck } from "lucide-react";
import Section from "../Section";
import RevealUp from "../RevealUp";

export default function AboutSection() {
  return (
    <Section id="about" className="!h-auto min-h-[100dvh]" style={{ background: "#ffffff" }}>
      <div className="mt-6 md:mt-0 relative z-10 flex flex-col items-center justify-center text-center px-6 lg:px-12 xl:px-20 pt-24 pb-12">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 lg:gap-6 max-w-5xl lg:max-w-6xl xl:max-w-7xl w-full">
          {[
            ...
            { label: "Transactions volume", value: "500K+", sub: "processed annually", pct: 85, Icon: ArrowRightLeft, barColor: "bg-[#22c55e]", iconColor: "text-[#22c55e]", border: "border-[#F97316]/30" },
            { label: "System uptime", value: "99.74%", sub: "last 12 months", pct: 99.74, Icon: ShieldCheck, barColor: "bg-[#F97316]", iconColor: "text-[#F97316]", border: "border-[#22c55e]/30" },
          ].map(({ label, value, sub, pct, Icon, barColor, iconColor, border }, i) => (
            <RevealUp key={label} delay={0.1 + i * 0.08}>
              <div className={`rounded-2xl bg-white/20 backdrop-blur-md border ${border} p-4 text-left`}>
